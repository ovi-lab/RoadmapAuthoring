...
/// <summary>
/// Directly taken from the PocketGarden (https://github.com/buck-co/PocketGarden) project.
...
namespace ubc.ok.ovilab.roadmap
{
    ...
    public class GeospatialManager : Singleton<GeospatialManager>
    {
        ...
        /// </summary>
        public double BestHeadingAccuracy { get => _bestOrientationAccuracy; }
        ...
        [SerializeField] private float _minimumOrientationAccuracy = 50;//15
        ...
        private double _bestOrientationAccuracy = Mathf.Infinity;
        ...
        private bool TrackingIsValid()
        {
            ...
            if (!valid && EarthManager.EarthTrackingState == TrackingState.Tracking)
            {
                ...
                valid = EarthManager.CameraGeospatialPose.OrientationYawAccuracy <= _minimumOrientationAccuracy &&
        ...
        private bool CheckAccuracyImproved()
        {
            ...
            bool heading = EarthManager.CameraGeospatialPose.OrientationYawAccuracy < _bestOrientationAccuracy;
            ...
            {
                improved = true;
                _bestOrientationAccuracy = EarthManager.CameraGeospatialPose.OrientationYawAccuracy;
            }
            if (vertical)
            {
                improved = true;
        ...
        private bool CheckTargetAccuracyReached()
        {
            return EarthManager.CameraGeospatialPose.HorizontalAccuracy <= _targetHorizontalAccuracy &&
                   EarthManager.CameraGeospatialPose.OrientationYawAccuracy <= _targetHeadingAccuracy &&
        ...
        {
            return RequestGeospatialAnchor(EarthManager.CameraGeospatialPose);
        }
